  ...
  const we = [
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function k(t) {
        ...
        let r, n, l, d, c, p, u, m, v, w, y, E, T, M, C, P, L, z;
        e.params.cssMode &&
          ((e.wrapperEl.style.overflow = "hidden"),
          ...
          !t || (1 === o && A)
            ...
            : ((L = h.slideEl.offsetWidth),
              ...
              "number" == typeof f.currentY
                ? ((u = (f.currentX * s.scale) / I),
                  (m = (f.currentY * s.scale) / I))
      ...
      function X() {
        ...
        e.wrapperEl.addEventListener("pointerdown", C, s),
          ...
          e.wrapperEl.addEventListener("pointermove", I, a);
      }
      function B() {
        const t = e.zoom;
        if (!t.enabled) return;
        ...
        e.wrapperEl.removeEventListener("pointerdown", C, s),
          ...
          e.wrapperEl.removeEventListener("pointermove", I, a);
      }
