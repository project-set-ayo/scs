!(function (t, e) {
  ...
  var s = (function () {
          ...
          if (this.isRunning) {
            ...
            if (this.lerp)
              (this.value =
                ...
                (l = i),
                (h = o),
                (1 - (a = 1 - Math.exp(-s * r))) * l + a * h)),
                Math.round(this.value) === this.to &&
                  ((this.value = this.to), (u = !0));
            else {
              this.currentTime += e;
              var p = n(0, this.currentTime / this.duration, 1),
                v = (u = p >= 1) ? 1 : this.easing(p);
              this.value = this.from + (this.to - this.from) * v;
            }
            null == (c = this.onUpdate) || c.call(this, this.value, u),
              u && this.stop();
          }
        }),
        (e.stop = function t() {
    ...
    l = (function () {
      ...
      return (
        (e.emit = function t(e) {
          for (var i = this.events[e] || [], o = 0, n = i.length; o < n; o++)
        ...
        (e.on = function t(e, i) {
          var o,
            n = this;
          return (
            (null == (o = this.events[e]) ? void 0 : o.push(i)) ||
              (this.events[e] = [i]),
            function () {
              var t;
              n.events[e] =
      ...
      function t(t, e) {
        ...
        (this.onTouchStart = function (t) {
          ...
          (this.onWheel = function (t) {
            var e = t.deltaX,
              o = t.deltaY;
            i.normalizeWheel && ((e = n(-100, e, 100)), (o = n(-100, o, 100))),
              (e *= i.wheelMultiplier),
              (o *= i.wheelMultiplier),
              i.emitter.emit("scroll", { deltaX: e, deltaY: o, event: t });
          }),
          (this.element = t),
          (this.wheelMultiplier = void 0 === o ? 1 : o),
          (this.touchMultiplier = void 0 === s ? 2 : s),
          (this.normalizeWheel = void 0 !== r && r),
  ...
  return (function () {
    function t(t) {
      var e = this,
        ...
        _ = void 0 !== y && y,
        w = o.syncTouchLerp,
        T = o.__iosNoInertiaSyncTouchLerp,
        z = o.touchInertiaMultiplier,
        b = o.duration,
        L = o.easing,
        E = o.lerp,
        k = o.infinite,
        M = o.orientation,
        R = o.gestureOrientation,
        W = o.touchMultiplier,
        x = void 0 === W ? 1 : W,
        C = o.wheelMultiplier,
        O = void 0 === C ? 1 : C,
      ...
      (this.onVirtualScroll = function (t) {
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                (e.isScrolling = !1), e.animate.stop();
                return;
              }
              s.preventDefault();
              var a = n;
        ...
        (this.options = {
          ...
          smoothTouch: S,
          syncTouch: _,
          syncTouchLerp: void 0 === w ? 0.1 : w,
          __iosNoInertiaSyncTouchLerp: void 0 === T ? 0.4 : T,
          touchInertiaMultiplier: void 0 === z ? 35 : z,
          duration: b,
          easing:
            void 0 === L
              ? function (t) {
              ...
              : L,
          lerp: void 0 === E ? !b && 0.1 : E,
          infinite: void 0 !== k && k,
          gestureOrientation: void 0 === R ? "vertical" : R,
          orientation: void 0 === M ? "vertical" : M,
          touchMultiplier: x,
          wheelMultiplier: O,
          normalizeWheel: N,
          autoResize: Y,
        ...
        (this.animate = new s()),
        (this.emitter = new l()),
        (this.dimensions = new r({ wrapper: a, content: u, autoResize: Y })),
    ...
    return (
      ...
      (o.scrollTo = function t(e, i) {
        var o = this,
          ...
          y = s.programmatic,
          _ = void 0 === y || y;
        if ((!this.isStopped && !this.isLocked) || (void 0 !== S && S)) {
          if (["top", "left", "start"].includes(e)) e = 0;
          else if (["bottom", "right", "end"].includes(e)) e = this.limit;
          else if (
            ("string" == typeof e
              ? (T = document.querySelector(e))
              : null != (w = e) && w.nodeType && (T = e),
            T)
          ) {
            if (this.options.wrapper !== window) {
              var w,
                T,
                z = this.options.wrapper.getBoundingClientRect();
              l -= this.isHorizontal ? z.left : z.top;
            }
      ...
      (o.toggleClass = function t(e, i) {
        this.rootElement.classList.toggle(e, i),
        ...
        },
        {
          ...
          get: function t() {
            ...
            return this.options.infinite
              ? ((e = this.animatedScroll), ((e % (i = this.limit)) + i) % i)
              : this.animatedScroll;
          },
        },
        {
